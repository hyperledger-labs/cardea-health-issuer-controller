    ...
    [
      ...
      JSON.stringify({
        ...
        governance_file: {
          ...
          id: '<uuid>',
          description:
            'This document describes COVID health governance in a machine readable way.',
          last_updated: '2022-05-25',
          docs_uri: 'need_to_create',
          data_uri: 'need_to_create',
          topics: ['medical'],
          jurisdictions: ['US>NY>New York City', 'AW'],
          geos: ['USA', 'Ukraine'],
          schemas: [
            {
          ...
          protocols: [
            ...
            },
            {
              ...
              details: {
                ...
                presentation_definition:
                  'hl:zm9YZpCjPLPJ4Epc:z3TSgXTuaHxY2tsArhUreJ4ixgw9NW7DYuQ9QTPQJKDe',
              },
            },
            {
              ...
              details: {
                ...
                presentation_definition:
                  'hl:zm9YZpCjPLPJ4Epc:z3TSgXTuaHxY2tsArhUreJ4ixgw9NW7DYuQ9QTPQMJQd',
              },
            },
            {
              ...
              details: {
                ...
                presentation_definition:
                  'http://localhost:3100/api/presentation-exchange',
              },
            },
            {
            ...
            },
            {
              ...
              data: {
                ...
                question_answer: [
                  {
                    question:
                      'Have you received a question from ask question button?',
                  },
                  {
...
exports.down = function (db) {
  return db.runSql(`DELETE FROM settings WHERE key = 'governance';`, function (
    err,
  ) {
